...
const captions = [
  "Multivitamin Product Design",
  "Type Dreams Branding",
  "E-commerce Email Designs",
  "Keto Vitals Product Design & Marketing",
  "E-Commerce Marketing Email Gifs",
  "Body Earth Marketing Design",
  "Calm Thinking Amazon",
  "Organique Science Marketing Material",
  "Shadow Supplements Branding",
  "Courage Nutrition Branding",
  "Promotional Landing Page Design",
  "Variety of Literature and Packaging",
];
  ...
  (e.fn.poptrox_disableSelection = function () {
    ...
    (e.fn.poptrox = function (o) {
      ...
      var p,
        ...
        u = [],
        index = 1,
        images = [4, 3, 5, 6, 4, 6, 7, 5, 4, 5, 2, 6]; // EDIT THIS LIST
      (d = 0),
        (h = !1),
        (g = new Array()),
        (f = function () {
      ...
      return (
              ...
              s.popupIsFixed
                ? (x
                  ...
                  w.on("load", function () {
                    w.off("load"),
                      b.hide().trigger("stopSpinning"),
                      m.trigger("update", [t]).fadeIn(s.fadeSpeed),
        ...
        r.find(s.selector).each(function (index, element) {
          var o = Number(element.getAttribute("data-proj-id")) - 1;
          var t,
            p,
            i = e(this),
            r = i.find("img"),
